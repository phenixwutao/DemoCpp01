...
namespace ChainOfResponsibility
{
  ...
  // Handle Request
  void KongfuMan::FaceChallenge(int clevel)
  {
    if ((level < clevel) && (master != nullptr))
    {
      master->FaceChallenge(clevel);
    }
    else
    {
      ShowMe();
  ...
  void TestChainOfResponsibility()
  {
    ...
    s4->Add(ss1);
    s4->Add(ss3);
    ss1->FaceChallenge(84);
    ss1->FaceChallenge(93);
    ss2->FaceChallenge(84);
    ss2->FaceChallenge(93);
    ss3->FaceChallenge(84);
    ss3->FaceChallenge(93);
    ss4->FaceChallenge(84);
    ss4->FaceChallenge(93);
  }
}