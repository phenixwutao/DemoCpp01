...
/********************************************************************************************* 
* error C4996: 'std::transform::_Unchecked_iterators::_Deprecate': Call to 'std::transform' 
* with parameters that may be unsafe - this call relies on the caller to check that the passed 
* values are correct. To disable this warning, use -D_SCL_SECURE_NO_WARNINGS. 
