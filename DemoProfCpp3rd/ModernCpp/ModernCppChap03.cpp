...
namespace DemoComposingFunctionsIntoHigherOrderFunction
{
...
{
  FUNC_INFO;
  DemoComposingFunctionsIntoHigherOrderFunction::execute();
}

namespace DemoUniformlyInvokingAnythingCallable
{
...
{
  FUNC_INFO;
  DemoUniformlyInvokingAnythingCallable::execute();
}
