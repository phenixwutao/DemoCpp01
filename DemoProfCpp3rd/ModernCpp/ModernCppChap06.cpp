...
#include <cstdlib>
namespace DemoRegisteringFunctionCalledWhenProgramExitsNormally // recipe_6_08
{
  void exit_handler_1()
  {
...
void Ch06_DemoRegisteringFunctionCalledWhenProgramExitsNormally()
{
  FUNC_INFO;
  DemoRegisteringFunctionCalledWhenProgramExitsNormally::execute();
}
